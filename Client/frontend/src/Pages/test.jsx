...
const TestingFacilities = () => {
  return (
    <div className="creativesplanet-box-content-inner">
      <div className="flex flex-col items-center justify-center bg-neutral-800 min-h-screen py-8"> {/* Added py-8 for equal padding top and bottom */}
        <h2 className="text-3xl font-bold text-white mb-8">Testing Facilities</h2>
